    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-md mx-auto">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Accedi</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-2">Accedi al tuo account per gestire le tue richieste</p>
            </div>
            ...
            <div class="glass-card p-10 rounded-3xl border border-slate-200 dark:border-slate-800">
                ...
                <p class="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
                    Non hai un account? <a href="{{ route('register') }}" class="text-amber-500 hover:text-amber-400 font-bold">Registrati</a>
                </p>
            </div>
        </div>
    </div>
