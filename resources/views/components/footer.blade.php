    ...
    <div class="grid md:grid-cols-4 gap-12 mb-12">
      <div class="space-y-4">
        ...
        <div class="pt-2 flex flex-col gap-1.5 items-start">
          ...
          <span class="text-sm font-bold transition-colors cursor-pointer text-left flex items-center gap-1.5 dark:text-yellow-400 text-yellow-600 hover:text-yellow-500" onclick="document.getElementById('chat-toggle')?.click()">Parla con Nova AI &#x1F916;</span>
        </div>
        <div class="flex gap-4">
          <a href="https://twitter.com/starlabdesign" target="_blank" rel="noopener noreferrer" class="transition-colors hover:scale-110 transform duration-200 dark:text-zinc-500 dark:hover:text-blue-400 text-slate-400 hover:text-blue-400">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://instagram.com/starlabdesign" target="_blank" rel="noopener noreferrer" class="transition-colors hover:scale-110 transform duration-200 dark:text-zinc-500 dark:hover:text-pink-400 text-slate-400 hover:text-pink-500">
          ...
          <a href="https://linkedin.com/company/starlabdesign" target="_blank" rel="noopener noreferrer" class="transition-colors hover:scale-110 transform duration-200 dark:text-zinc-500 dark:hover:text-blue-400 text-slate-400 hover:text-blue-600">
